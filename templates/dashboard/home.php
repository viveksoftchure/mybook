            ...
            <div class="grid-item card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="fs-16 fw-semibold">Total Income</span>
                            </div>
                            <h4 class="my-2 fs-24 fw-semibold"><?= $data['this_month_income'] ? formatToINR($data['this_month_income']) : 0; ?></h4>
                            <p class="mb-0 text-muted fw-semibold">This Month's Income</p>
                        </div>
                        <div>
                            <i class="svg-icon svg-line-graph-up mb-2 fs-72"></i>
                            <span class="badge badge-primary"><?= $data['income_increment'] ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-item card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="fs-16 fw-semibold">Total Expense</span>
                            </div>
                            <h4 class="my-2 fs-24 fw-semibold"><?= $data['this_month_expense'] ? formatToINR($data['this_month_expense']) : 0; ?></h4>
                            <p class="mb-0 text-muted fw-semibold">This Month's Expense</p>
                        </div>
                        <div>
                            <i class="svg-icon svg-line-graph-up mb-2 fs-72"></i>
                            <span class="badge badge-danger"><?= $data['expense_increment'] ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid-item card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="fs-16 fw-semibold">Total Savings</span>
                            </div>
                            <h4 class="my-2 fs-24 fw-semibold"><?= $data['this_month_saving'] ? formatToINR($data['this_month_saving']) : 0; ?></h4>
                            <p class="mb-0 text-muted fw-semibold">This Month's Saving</p>
                        </div>
                        <div>
                            <i class="svg-icon svg-line-graph-up mb-2 fs-72"></i>
                            <span class="badge badge-primary"><?= $data['saving_increment'] ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
